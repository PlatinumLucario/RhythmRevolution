...
namespace RevolutionFileLoader {
    public class PatriciaTree : IWriteable {
        ...
        public class PatriciaTreeItem : IPatriciaTreeItem {
            ...
            public IdType SoundType { get; set; }
        ...
        public void Write(FileWriter w) {
            ...
            foreach (var n in _nodes) {
                w.Write((ushort)(n.ContainsData ? 1 : 0));
                w.Write(n.ContainsData ? (ushort)0xFFFF : (ushort)n.Bit);
                w.Write(n.Left == null ? -1 : n.Left.Index);
                w.Write(n.Right == null ? -1 : n.Right.Index);
                int stringIndex = -1;
                int itemIndex = -1;
                if (n.ContainsData) {
                    stringIndex = n.StringTableIndex;
