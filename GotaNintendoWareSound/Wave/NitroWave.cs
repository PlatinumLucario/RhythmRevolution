...
namespace GotaNintendoWare.Wave {
    ...
    /// A wave.
    /// </summary>
    public class NitroWave : SoundFile {
        ...
        public static NitroWave ReadShortened(FileReader r, uint length) {

            //Set up wave.
            NitroWave w = new NitroWave();
        ...
        public override void Write(FileWriter w) {
            ...
            //Write the file.
            w.InitFile<NFileHeader>("SWAV", ByteOrder.LittleEndian, null, 1);
            w.InitBlock("DATA");
            WriteShortened(w);
            w.CloseBlock();
            w.CloseFile();
